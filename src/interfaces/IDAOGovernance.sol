...
interface IDAOGovernance {
    ...
    // Core Functions
    function proposeEmissionSplit(uint256[] calldata contestWeights, string calldata description) external returns (uint256 proposalId);
    function proposeEmissionRate(uint256 newRate, string calldata description) external returns (uint256 proposalId);
    function proposeContestWeight(address contest, uint256 weight, string calldata description) external returns (uint256 proposalId);
